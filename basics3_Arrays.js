...
marks[3] = 14 //reassigning value of array element
console.log(marks) //[20,40,35,14,37,100]
console.log(marks.length) //6
marks.push(65) //to append new element to array in the end
console.log(marks) //[20,40,35,14,37,100,65]
marks.pop()//[20,40,35,14,37,100]
marks.unshift(12) //adds ele in the begining of array
console.log(marks)
...
console.log(sum)
//reduce filter map
let total =marks.reduce((sum,mark)=>sum+mark,0) //ananymous function takes two arguments. here 0 is initializer
console.log(total)
...
let totalVal=mappedArray.reduce((sum,val)=>sum+val,0) //add all items from mappedArray
...
//reduce: useful when we have to accumulate one value and add/substract/multple to other etc..
//filter: useful to filter the ele like even,odd
//map: modify each value to new value
